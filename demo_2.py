...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 19 20:15:30 2018
...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 19 15:23:01 2018
...
#    optimizer = torch.optim.Adam(model_wrapper.parameters(), lr=lr, weight_decay=wd, amsgrad=True)
    ...
    # Start log
    if os.path.exists(os.path.join(save, 'conditional_VGG16_nesterov_results_2.csv')):
        os.remove(os.path.join(save, 'conditional_VGG16_nesterov_results_2.csv'))
    with open(os.path.join(save, 'conditional_VGG16_nesterov_results_2.csv'), 'w') as f:
        f.write('epoch, '
    ...
    best_MAE = 100
    model_state_dir=os.path.join(save, 'conditional_VGG16_nesterov_model_2.dat')
...
#         Determine if model is the best
        ...
        with open(os.path.join(save, 'conditional_VGG16_nesterov_results_2.csv'), 'a') as f:
            f.write('%03d, '
                    '%0.3f, %0.3f, %0.3f, '
                    '%0.3f, %0.3f, %0.3f, '
                    '%0.3f, %0.3f, %0.3f, '
